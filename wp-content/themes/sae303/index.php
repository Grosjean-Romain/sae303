...
<div class="container">
    <h1 class="title-hero">Présidentielles Françaises Évolution des Données autour des Élections au cours de ces 20 dernières années (2002 - 2022)</h1>
    ...
    <div class="card-container">
        <a href="repartition" class="card">
            <img src="<?php echo get_template_directory_uri(); ?>/images/image1.png" alt="Répartition par Département">
        ...
        <a href="abstention" class="card">
            <img src="<?php echo get_template_directory_uri(); ?>/images/image2.png" alt="Évolution de l'Abstention">
            <h2>Évolution du Taux d'Abstention aux Élections Présidentielles en France (2002 - 2022)</h2>
        </a>
        <a href="score" class="card">
            <img src="<?php echo get_template_directory_uri(); ?>/images/image3.png" alt="Scores des Candidats">
            <h2>Résultats du Deuxième Tour des Élections Présidentielles Française (2017 - 2022)</h2>
        </a>
    </div>
